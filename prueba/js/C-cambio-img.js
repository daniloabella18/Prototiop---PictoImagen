...
function CambioImagen1() {
	cuadro1 = cuadro1 + 1;
	document.getElementById("onom1").src = "assets/images/Tematica/Granja/Cerdo/C-Ono-1.png";
}

// Img 2
function CambioImagen2() {
	cuadro2 = cuadro2 + 1;
	document.getElementById("onom2").src = "assets/images/Tematica/Granja/Cerdo/C-Ono-2.png";
  x = false;
}
...
function CambioImagen3() {
	cuadro3 = cuadro3 + 1;
	document.getElementById("onom3").src = "assets/images/Tematica/Granja/Cerdo/C-Ono-3.png";
}

// Img 4
function CambioImagen4() {
	cuadro4 = cuadro4 + 1;
	document.getElementById("onom4").src = "assets/images/Tematica/Granja/Cerdo/C-Ono-4.png";
}
