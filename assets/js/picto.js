...
function OnomFin() {
	...
	function FinalMsj() {
	    document.getElementById("cartel").className = "bien hecho";
			...
			document.getElementById("cu1").className = "single-plan wow fondo osc";
			document.getElementById("cu2").className = "single-plan wow fondo osc";
			document.getElementById("cu3").className = "single-plan wow fondo osc";
			document.getElementById("cu4").className = "single-plan wow fondo osc";
	}
